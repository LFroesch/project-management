      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="text-center flex-1">
            <h1 className="text-4xl font-bold text-base-content">Contact Support</h1>
            <p className="text-lg text-base-content/70 mt-2">Need help? Submit a support ticket and we'll get back to you</p>
          </div>
