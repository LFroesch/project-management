      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="text-center flex-1">
            ...
            <p className="text-lg text-base-content/70 mt-2">Manage users, tickets, and view system statistics</p>
          </div>
        ...
        {/* Users Table */}
        {activeTab === 'users' && (
          <div className="card bg-base-100 shadow-xl" style={{ overflow: 'visible' }}>
