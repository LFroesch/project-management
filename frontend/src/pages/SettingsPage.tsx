      ...
      {deleteConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-base-100 rounded-lg shadow-xl p-6 w-full max-w-md">
            ...
            <h3 className="text-xl font-bold text-center mb-4">Delete Project</h3>
            
            <p className="text-center text-base-content/70 mb-6">
              Are you sure you want to delete "<strong>{selectedProject?.name}</strong>"? This will permanently delete the project and all of its data. This action cannot be undone.
            </p>
